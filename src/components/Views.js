    ...
    <div class="container">
      <div class="section fade-in-up">
        ...
        <div class="contact-footer fade-in-up">
          ...
          <!-- Anti-ad-blocker: Using generic professional network terminology -->
          <a href="https://linkedin.com/in/jose-rodriguez-engineer" class="professional-network-link" target="_blank" rel="noopener noreferrer" aria-label="Connect with Jose Rodriguez on Professional Network">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" role="img" aria-hidden="true">
              <!-- Professional network icon instead of LinkedIn-specific SVG -->
              <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM8.5 17.5h-2v-7h2v7zM7.5 9.5C6.67 9.5 6 8.83 6 8s.67-1.5 1.5-1.5S9 7.17 9 8s-.67 1.5-1.5 1.5zM18 17.5h-2v-3.5c0-.83-.67-1.5-1.5-1.5S13 13.17 13 14v3.5h-2v-7h2v1c.5-.5 1.17-1 2-1 1.38 0 2.5 1.12 2.5 2.5v4.5z"/>
            </svg>
            <span>Professional Network Profile</span>
          </a>
